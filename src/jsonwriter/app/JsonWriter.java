...
//        Address address = new Address("Main Street", (short) 1);
    ...
    static String formatPrimitiveValue(Field field, Object parentInstance) throws IllegalAccessException {
        if (field.getType().equals(boolean.class)
            ...
            return "%.02f".formatted(field.get(parentInstance));
        }
        throw new RuntimeException("Type : %s is unsupported".formatted(field.getType().getName()));
    }
}
